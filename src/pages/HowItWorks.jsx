        ...
        <div className={styles.steps}>
          ...
          <div className={styles.step}>
            ...
            <div className={styles.stepContent}>
              ...
              <p className={styles.stepDesc}>Te döntöd el mikor megfelelő az ár Neked — nincs időkorlát, az aukció addig tart amíg valaki úgy dönt, Neki jó az ár és elviszi a terméket.</p>
            </div>
          </div>
