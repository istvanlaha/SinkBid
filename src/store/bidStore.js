...
export const INITIAL_PRODUCTS = [
  ...
  { id: 5, category: 'orak', name: 'IWC Portugieser Chronograph', description: 'Stainless steel, silver dial, leather strap. IWC service history.', originalPrice: 7800, emoji: '⌚', image: 'https://images.unsplash.com/photo-1618220179428-22790b461013?w=600&q=80' },
  { id: 6, category: 'orak', name: 'Audemars Piguet Royal Oak Offshore', description: '44mm titanium case, black dial, rubber strap. Full set.', originalPrice: 38000, emoji: '⌚', image: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&q=80' },
  { id: 7, category: 'orak', name: 'Breitling Navitimer B01 Chronograph', description: '43mm steel, black dial, pilot bracelet. COSC certified.', originalPrice: 8900, emoji: '⌚', image: 'https://images.unsplash.com/photo-1594534475808-b18fc33b045e?w=600&q=80' },
  { id: 8, category: 'orak', name: 'Jaeger-LeCoultre Reverso Classic Small', description: 'Stainless steel, white dial, alligator strap. Ladies model.', originalPrice: 6400, emoji: '⌚', image: 'https://images.unsplash.com/photo-1548171915-f9ac7ed78d6b?w=600&q=80' },
  ...
  { id: 37, category: 'muveszet', name: 'Bronze Sculpture Art Nouveau Figure', description: 'Patinated bronze, marble base, 45cm height. Signed by artist.', originalPrice: 12000, emoji: '🗿', image: 'https://images.unsplash.com/photo-1554188248-986adbb73be4?w=600&q=80' },
  { id: 38, category: 'muveszet', name: 'Tiffany Style Stained Glass Lamp', description: 'Leaded glass shade, dragonfly motif, original patina base. 1920s.', originalPrice: 6800, emoji: '💡', image: 'https://images.unsplash.com/photo-1513506003901-1e6a35007946?w=600&q=80' },
  { id: 39, category: 'muveszet', name: 'Watercolor Landscape by Listed Artist', description: '40x60cm, framed, signed. Provenance documentation included.', originalPrice: 2800, emoji: '🎨', image: 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=600&q=80' },
